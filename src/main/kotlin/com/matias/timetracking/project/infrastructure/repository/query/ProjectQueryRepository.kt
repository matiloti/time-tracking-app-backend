...
@Repository
class ProjectQueryRepository(val projectDao: ProjectDao, val milestoneDao: MilestoneDao) {

    fun getProjectDetailsById(projectId: UUID): ProjectDetailsDto? = projectDao
